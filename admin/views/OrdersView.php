 			...
 			<table class="table table-hover table-borderd">
 				<tr>
                    ...
                    <th>Giờ mua</th>
 					...
 					<th style="width:150px;text-align:center;">Tuỳ chọn</th>
 				</tr>
 				...
 				<tr>
                    ...
                    echo date("H:i:s",strtotime($rows->Times));
 					...
 					<td>
 						<?php if($rows->status == 1): ?>
 							<div class="product-dont"><i class="fas fa-check-circle"></i>Đã giao hàng</div>
 						<?php else: ?>
