 ...
 <div class="main-content position-relative bg-gray-100  h-100">
   <div class="col-md-12">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading" style="color: #333;font-weight: 700;font-size: 20px;">List products</div>
        <div class="panel-body">
            <table class="table table-bordered table-hover">
                <tr>   
                    <th style="width: 100px;color: #333">Photo
                        
                    </th>
                    <th style="color: #333;">Name</th>
                    <th style="width: 200px;color: #333">category</th>
                    <th style="width:50px;color: #333">Hot</th>
            ...
            <ul class="pagination">
                <li class="page-item  " ><a href="#" style="color: #333" class="page-link">Trang</a></li>
                <?php for($i = 1; $i <= $numPage; $i++): ?>
                <li class="page-item"><a href="index.php?controller=products&p=<?php echo $i; ?>"  style="color: #333" class="page-link"><?php echo $i; ?></a></li>
                <?php endfor; ?>
            </ul>
        </div>
    </div>
