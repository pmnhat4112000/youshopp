        ...
        <div class="panel-body">
            <table class="table table-bordered table-hover">
                <tr>
                    ...
                    <th>Tên</th>
                    <th style="width:80px;">giá gốc</th>
                    <th style="width:80px;">giảm giá </th>
                     
                    <th style="width:80px;">giá đã giảm</th>
                    <th style="width:80px;">Số lượng</th>
                </tr>
                <?php foreach($data as $rows): ?>
                    <?php $product = $this->modelGetProduct($rows->product_id); ?>
                    <?php $quantity = $this->modelOrdersDetail($id); ?>
                ...
                <tr>
                    ...
                    <td style="text-align:center;"> 
                        <?php echo number_format($rows->price - ($rows->price * $product->discount)/100); ?>đ</td>
 
                   <td> x <?php echo $rows->quantity;  ?></td>
