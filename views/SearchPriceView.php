                    ...
                    <div class="column-12-product mb-12 ">
                        ...
                        <div class="column-9-12 cl-12 ">
                            <div class="grid">
                              ...
                              <h2>giá từ <?php echo number_format($fromPrice); ?>VNĐ - đến <?php echo number_format($toPrice); ?>VNĐ</h2>
                                 <?php 
...
<?php endforeach; ?>
        ...
        <div class="pagination">
          <span><a class="pagination-number">Trang</a></span>
            ...
            <span><a class="page-link pagination-number" href="index.php?controller=search&action=price&fromPrice=<?php echo $fromPrice; ?>&toPrice=<?php echo $toPrice; ?>&p=<?php echo $i; ?>"><?php echo $i; ?></a></span>
         <?php endfor; ?>
        </div>
</div>
